...
def coffee_wavelength_plots():

    coffee_248 = ag.Agilette('/Users/jonathan/0_jono_data').library.single_runs['2023-02-23_LOR-RISTRETTO.D'].extract_ch_data()['248.0']
