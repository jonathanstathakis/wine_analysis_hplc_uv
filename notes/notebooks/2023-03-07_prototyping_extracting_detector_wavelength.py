...
coffee_248 = ag.data_file_dir.single_runs['2023-02-23_LOR-RISTRETTO.D'].extract_ch_data()['248.0']

coffee_248['data'].plot(x = 'mins', y = 'mAU', title = coffee_248['signal_info'], legend = False)
