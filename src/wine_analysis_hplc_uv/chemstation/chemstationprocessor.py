...
class ChemstationProcessor:
    ...
    def __init__(self, lib_path: str, usepickle: bool = False):
        ...
        test_dup_hash_keys(self.metadata_df)
...
def test_dup_hash_keys(metadata_df: List[dict]) -> None:
    ...
    list_of_keys: List[str] = metadata_df["hash_key"].tolist()
