...
def entry_func(data_lib_path : str, con : db.DuckDBPyConnection):
    ...
    chemstation_data_dicts_tuple = pickle_chemstation_data.pickle_interface(pickle_filepath, uv_paths_list, con)

    # write the uv_metadata and data to tables in the given db.
    chemstation_to_db_methods.write_chemstation_data_to_db_entry(chemstation_data_dicts_tuple, con)
