...
def pickle_interface(pickle_filepath : str, uv_paths_list : list, con : db.DuckDBPyConnection):
    ...
    if os.path.isfile(pickle_filepath):
        ...
        # if overrwite is selected, deleted old pickle, run chemstation process, write new pickle
            ...
            chemstation_data_dicts_tuple = init_chemstation_data_metadata.process_chemstation_uv_files(uv_paths_list, con)
    ...
    # if pickle doesnt exist, ask if want to create.
        ...
        # for any other response, just continue process.
            ...
            chemstation_data_dicts_tuple = init_chemstation_data_metadata.process_chemstation_uv_files()
        return chemstation_data_dicts_tuple
    else:
