...
class ChemstationProcessor():
    def __init__(self, datalibpath: str):
        ...
        self.fpathlist: List[str] = chemstation_methods.uv_filepaths_to_list(root_dir_path = datalibpath)
        
        self.ch_data_dicts_tuple: Tuple[list[dict], list[dict]] = pickle_chemstation_data.pickle_interface(pickle_filepath=self.pkfpath, uv_paths_list=self.fpathlist)
    
    def to_db(self, db_filepath: str, ch_metadata_tblname: str = "ch metadata", ch_sc_tblname: str = "ch sc data") -> None:
...
if __name__ == "__main__":
    ChemstationProcessor("/Users/jonathan/mres_thesis/wine_analysis_hplc_uv.py/data/cuprac_data"
)
